...
def upgrade() -> None:
    ...
    sa.Column('genre', postgresql.ENUM('FICTION', 'NON_FICTION', 'SCIENCE', 'HISTORY', 'BIOGRAPHY', 'FANTASY', 'MYSTERY', 'ROMANCE', 'THRILLER', 'CHILDREN', 'POETRY', 'PHILOSOPHY', 'SELF_HELP', 'TRAVEL', 'COOKING', 'ART', 'RELIGION', 'BUSINESS', 'HEALTH', 'TECHNOLOGY', name='genre_enum'), nullable=False),
